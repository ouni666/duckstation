...
//  which can be used on function pointers.
#ifdef _MSC_VER 
...
// 添加 LoongArch 架构支持 
#if defined(CPU_ARCH_LOONGARCH)
#define CPU_ARCH_STR "loongarch"
...
#elif defined(__APPLE__) && defined(__aarch64__)
static constexpr u32 HOST_CACHE_LINE_SIZE = 128;
// 添加 LoongArch 缓存行支持 
#elif defined(__loongarch__)
static constexpr u32 HOST_CACHE_LINE_SIZE = 128;
#else 
static constexpr u32 HOST_CACHE_LINE_SIZE = 64;
#endif 
