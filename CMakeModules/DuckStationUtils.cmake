From 1f08c5b85ae9c421e6025b710b68c2cedf8406f3 Mon Sep 17 00:00:00 2001
From: ouni666 <fangwenbin@vip.qq.com>
Date: Tue, 13 May 2025 09:47:43 +0800
Subject: [PATCH] support loongarch64

---
 CMakeModules/DuckStationUtils.cmake | 442 ++++++++++++++--------------
...
index d7ea0b096..667ab8edd 100644
...
+        message(STATUS "Building LoongArch64 binaries.")
+        set(CPU_ARCH_LOONGARCH64 TRUE PARENT_SCOPE)
+        # 这里可以根据需要添加针对 LoongArch64 的编译选项
...
-    set(TEMP_FILE "${CMAKE_BINARY_DIR}${CMAKE_FILES_DIRECTORY}/CMakeTmp/src.cpp")
-    file(WRITE "${TEMP_FILE}" "#include <version>
+    set(CACHE_VAR "CHECK_CPP20_ATTRIBUTE_${ATTRIBUTE}")
+    if(NOT DEFINED ${CACHE_VAR})
+        set(TEMP_FILE "${CMAKE_BINARY_DIR}${CMAKE_FILES_DIRECTORY}/CMakeTmp/src.cpp")
+        file(WRITE "${TEMP_FILE}" "#include <version>
